...
module "container_registry" {
  source     = "git::https://github.com/wri/gfw-terraform-modules.git//modules/container_registry?ref=v0.0.5"
...
module "compute_environment_ephemeral_storage" {
  source             = "git::https://github.com/wri/gfw-terraform-modules.git//modules/compute_environment_ephemeral_storage?ref=v0.0.5"
