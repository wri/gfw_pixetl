...
SRC = {
    ...
    "bgc_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/belowground_carbon/loss_pixels/standard/20191016/{tile_id}_t_BGC_ha_emis_year.tif",
    ...
    "deadwood_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/deadwood_carbon/loss_pixels/standard/20191016/{tile_id}_t_deadwood_C_ha_emis_year_2000.tif",
    ...
    "litter_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/litter_carbon/loss_pixels/standard/20191016/{tile_id}_t_litter_C_ha_emis_year_2000.tif",
    ...
    "soil_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/standard/20191016/{tile_id}_t_soil_C_ha_emis_year_2000.tif",
    ...
    "total_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/total_carbon/loss_pixels/standard/20191016/{tile_id}_t_total_C_ha_emis_year.tif",
