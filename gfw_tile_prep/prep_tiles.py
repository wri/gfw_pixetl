...
SRC = {
       "FluxModelExtent": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/model_extent/standard/{tile_id}.tif",
    ...
    "ForestAgeCategory": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/forest_age_category/standard/{tile_id}.tif",
    ...
    "AnnualAbovegroundRemovalRateCarbon": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/annual_removal_factor_AGC_all_forest_types/standard/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "AnnualBelowgroundRemovalRateCarbon": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/annual_removal_factor_BGC_all_forest_types/standard/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "StdevAnnualAbovegroundRemovalsCarbon": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/stdev_annual_removal_factor_AGC_all_forest_types/standard/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "GrossCumulAbovegroundRemovalsCo2": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/gross_removals_AGCO2_all_forest_types/standard/{tile_id}.tif",
    ...
    "GrossCumulBelowgroundRemovalsCo2": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/gross_removals_BGCO2_all_forest_types/standard/{tile_id}.tif",
    ...
    "AgcEmisYear": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/agc_emis_year/standard/{tile_id}.tif",
    ...
    "BgcEmisYear": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/bgc_emis_year/standard/{tile_id}.tif",
    ...
    "DeadwoodCarbonEmisYear": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/deadwood_emis_year/standard/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/biomass_swap/20200107/{tile_id}_t_AGC_ha_emis_year_biomass_swap.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/US_removals/20200107/{tile_id}_t_AGC_ha_emis_year_US_removals.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/US_removals/{tile_id}.tif",
    ...
    "LitterCarbonEmisYear": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/litter_emis_year/standard/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/biomass_swap/20200107/{tile_id}_t_AGC_ha_emis_year_biomass_swap.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/US_removals/20200107/{tile_id}_t_AGC_ha_emis_year_US_removals.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/US_removals/{tile_id}.tif",
    ...
    "SoilCarbonEmisYear": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/soil_emis_year/standard/{tile_id}.tif",
    ...
    "BurnYearHansenLoss": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/burn_year_with_Hansen_loss/{tile_id}.tif",
        "data_type": "Byte",
        "nodata": 0
    },
    "Drivers": {
    ...
    "GrossEmissionsCo2OnlyCo2e": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/CO2_only/biomass_soil/standard/20210305/{tile_id}_gross_emis_CO2_only_all_drivers_Mg_CO2e_ha_biomass_soil_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/gross_emissions_co2_only_co2e/standard/{tile_id}.tif",
    ...
    "GrossEmissionsCo2eNonCo2": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/non_CO2/biomass_soil/standard/20210305/{tile_id}_gross_emis_non_CO2_all_drivers_Mg_CO2e_ha_biomass_soil_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/gross_emissions_non_co2_co2e/standard/{tile_id}.tif",
    ...
    "GrossEmissionsNodeCodes": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/decision_tree_nodes/biomass_soil/standard/20210305/{tile_id}_gross_emis_decision_tree_nodes_biomass_soil_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/gross_emissions_node_codes/standard/{tile_id}.tif",
    ...
    "NetFluxCo2e": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/net_flux_all_forest_types_all_drivers/biomass_soil/standard/full_extent/per_hectare/20210305/{tile_id}_net_flux_Mg_CO2e_ha_biomass_soil_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_2_1_1/net_flux_all_forest_types_all_drivers/standard/{tile_id}.tif",
