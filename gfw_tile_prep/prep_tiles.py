...
SRC = {
    ...
    "agc_emis_year": {
        ...
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/US_removals/20191230/{tile_id}_t_AGC_ha_emis_year_US_removals.tif",
    ...
    "soil_carbon_emis_year": {
        ...
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/US_removals/20191230/{tile_id}_t_soil_C_ha_emis_year_2000_US_removals.tif",
    ...
    "gross_emissions_co2_only_co2e": {
        ...
        # "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/CO2_only/biomass_soil/US_removals/20191230/{tile_id}_gross_emis_CO2_only_all_drivers_t_CO2e_ha_biomass_soil_US_removals.tif",
    ...
    "gross_emissions_non_co2_co2e": {
        ...
        # "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/non_CO2/biomass_soil/US_removals/20191230/{tile_id}_gross_emis_non_CO2_all_drivers_t_CO2e_ha_biomass_soil_US_removals.tif",
    ...
    "net_flux_co2e": {
        ...
        # "src": "{protocol}/gfw2-data/climate/carbon_model/net_flux_all_forest_types_all_drivers/biomass_soil/US_removals/20191230/{tile_id}_net_flux_t_CO2e_ha_2001_15_biomass_soil_US_removals.tif",
    ...
    "JPL_AGB_extent": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/Saatchi_JPL_biomass/1km_2000/raw_combined/Saatchi_1km_AGB_2000_Mg_ha_combined.tif",
