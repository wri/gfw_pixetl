...
SRC = {
    ...
    "gross_emissions_co2_only_co2e": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/CO2_only/20190523/{tile_id}_CO2_only_all_drivers_t_CO2e_ha_gross_emis_year.tif",
    ...
    "net_flux_co2e": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/net_flux_all_forest_types_all_drivers/20190524/{tile_id}_net_flux_t_CO2e_ha_2001_15.tif",
