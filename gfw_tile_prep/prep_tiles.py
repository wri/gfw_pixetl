...
SRC = {
       "FluxModelExtent": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/model_extent/standard/20210223/{tile_id}_model_extent.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/model_extent/standard/{tile_id}.tif",
    ...
    "ForestAgeCategory": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/forest_age_category_IPCC/standard/20210223/{tile_id}_forest_age_category_IPCC__1_young_2_mid_3_old.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/forest_age_category/standard/{tile_id}.tif",
    ...
    "RemovalForestType": {
        ...
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/removal_forest_type/standard/{tile_id}.tif",
    ...
    "AnnualAbovegroundRemovalRateCarbon": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/annual_removal_factor_AGC_all_forest_types/standard/20210223/{tile_id}_annual_removal_factor_AGC_Mg_ha_all_forest_types.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/annual_removal_factor_AGC_all_forest_types/standard/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "AnnualBelowgroundRemovalRateCarbon": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/annual_removal_factor_BGC_all_forest_types/standard/20210223/{tile_id}_annual_removal_factor_BGC_Mg_ha_all_forest_types.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/annual_removal_factor_BGC_all_forest_types/standard/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "StdevAnnualAbovegroundRemovalsCarbon": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/stdev_annual_removal_factor_AGC_all_forest_types/standard/20210223/{tile_id}_annual_removal_factor_stdev_AGC_Mg_ha_all_forest_types.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/stdev_annual_removal_factor_AGC_all_forest_types/standard/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "GrossCumulAbovegroundRemovalsCo2": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_removals_AGCO2_all_forest_types/standard/per_hectare/20210224/{tile_id}_gross_removals_AGCO2_Mg_ha_all_forest_types_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/gross_removals_AGCO2_all_forest_types/standard/{tile_id}.tif",
    ...
    "GrossCumulBelowgroundRemovalsCo2": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_removals_BGCO2_all_forest_types/standard/per_hectare/20210224/{tile_id}_gross_removals_BGCO2_Mg_ha_all_forest_types_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/gross_removals_BGCO2_all_forest_types/standard/{tile_id}.tif",
    ...
    "AgcEmisYear": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/standard/20210224/{tile_id}_Mg_AGC_ha_emis_year.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/agc_emis_year/standard/{tile_id}.tif",
    ...
    "BgcEmisYear": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/belowground_carbon/loss_pixels/standard/20210224/{tile_id}_Mg_BGC_ha_emis_year.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/bgc_emis_year/standard/{tile_id}.tif",
    ...
    "DeadwoodCarbonEmisYear": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/deadwood_carbon/loss_pixels/standard/20210224/{tile_id}_Mg_deadwood_C_ha_emis_year_2000.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/deadwood_emis_year/standard/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/biomass_swap/20200107/{tile_id}_t_AGC_ha_emis_year_biomass_swap.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/US_removals/20200107/{tile_id}_t_AGC_ha_emis_year_US_removals.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/US_removals/{tile_id}.tif",
    ...
    "LitterCarbonEmisYear": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/litter_carbon/loss_pixels/standard/20210224/{tile_id}_Mg_litter_C_ha_emis_year_2000.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/litter_emis_year/standard/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/biomass_swap/20200107/{tile_id}_t_AGC_ha_emis_year_biomass_swap.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/US_removals/20200107/{tile_id}_t_AGC_ha_emis_year_US_removals.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/US_removals/{tile_id}.tif",
    ...
    "SoilCarbonEmisYear": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/standard/20210224/{tile_id}_Mg_soil_C_ha_emis_year_2000.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/soil_emis_year/standard/{tile_id}.tif",
    ...
    "BurnYearHansenLoss": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/other_emissions_inputs/burn_year/burn_year_with_Hansen_loss/20210218/{tile_id}_burnyear_with_Hansen_loss.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/burn_year_with_Hansen_loss/{tile_id}.tif",
        "data_type": "Byte",
        "nodata": 0
    },
    "Drivers": {
    ...
    "GrossEmissionsCo2OnlyCo2e": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/CO2_only/soil_only/standard/20210324/{tile_id}_gross_emis_CO2_only_all_drivers_Mg_CO2e_ha_soil_only_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/gross_emissions_co2_only_co2e/soil_only/{tile_id}.tif",
    ...
    "GrossEmissionsCo2eNonCo2": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/non_CO2/soil_only/standard/20210324/{tile_id}_gross_emis_non_CO2_all_drivers_Mg_CO2e_ha_soil_only_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/gross_emissions_non_co2_co2e/soil_only/{tile_id}.tif",
    ...
    "GrossEmissionsNodeCodes": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/decision_tree_nodes/soil_only/standard/20210324/{tile_id}_gross_emis_decision_tree_nodes_soil_only_2001_20.tif",
        "s3_target": "{protocol}/gfw-files/flux_1_2_1/gross_emissions_node_codes/soil_only/{tile_id}.tif",
