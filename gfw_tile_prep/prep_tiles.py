...
SRC = {
    ...
    "gross_emissions_all_gas_co2e": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/all_gases/20190523/{tile_id}_all_gases_all_drivers_t_CO2e_ha_gross_emis_year.tif",
