...
SRC = {
    "gross_annual_removals_carbon": {
        "type": "raster",
        "src": "{protocol}climate/carbon_model/annual_gain_rate_all_forest_types/20190228/{tile_id}_annual_gain_rate_AGB_BGB_t_ha_all_forest_types.tif",
    ...
    "agc_emis_year": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/20190418/{tile_id}_t_AGC_ha_emis_year.tif",
    ...
    "bgc_emis_year": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/belowground_carbon/loss_pixels/20190430/{tile_id}_t_BGC_ha_emis_year.tif",
    ...
    "deadwood_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/deadwood_carbon/loss_pixels/20190430/{tile_id}_t_deadwood_C_ha_emis_year_2000.tif",
    ...
    "litter_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/litter_carbon/loss_pixels/20190430/{tile_id}_t_litter_C_ha_emis_year_2000.tif",
    ...
    "soil_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/20190430/{tile_id}_t_soil_C_ha_emis_year_2000.tif",
    ...
    "total_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/total_carbon/loss_pixels/20190430/{tile_id}_t_total_C_ha_emis_year.tif",
    ...
    "agc_2000": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/aboveground_carbon/extent_2000/20190531/{tile_id}_t_AGC_ha_2000.tif",
    ...
    "bgc_2000": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/belowground_carbon/extent_2000/20190531/{tile_id}_t_BGC_ha_2000.tif",
    ...
    "deadwood_carbon_2000": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/deadwood_carbon/extent_2000/20190531/{tile_id}_t_deadwood_C_ha_2000.tif",
    ...
    "litter_carbon_2000": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/litter_carbon/extent_2000/20190531/{tile_id}_t_litter_C_ha_2000.tif",
    ...
    "soil_carbon_2000": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/soil_carbon/intermediate_full_extent/20190419/{tile_id}_t_soil_C_ha_full_extent_2000.tif",
    ...
    "total_carbon_2000": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/carbon_pools/total_carbon/extent_2000/20190602/{tile_id}_t_total_C_ha_2000.tif",
    ...
    "gross_emissions_co2": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/gross_emissions/all_drivers/20190523/{tile_id}_all_drivers_t_CO2_ha_gross_emis_year.tif",
    ...
    "net_flux_co2": {
        "type": "raster",
        "src": "{protocol}/climate/carbon_model/net_flux_all_forest_types_all_drivers/20190524/{tile_id}_net_flux_t_CO2_ha_2001_15.tif",
