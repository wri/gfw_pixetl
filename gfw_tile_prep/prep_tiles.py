...
SRC = {
    ...
    "gross_emissions_non_co2_co2e": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/non_CO2/biomass_soil/legal_Amazon_loss/20200117/{tile_id}_gross_emis_non_CO2_all_drivers_t_CO2e_ha_biomass_soil_legal_Amazon_loss.tif",
