...
SRC = {
    ...
    "agc_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/standard/20191016/{tile_id}_t_AGC_ha_emis_year.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/standard/{tile_id}.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/maxgain/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "bgc_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/belowground_carbon/loss_pixels/standard/20191017/{tile_id}_t_BGC_ha_emis_year.tif",
    ...
    "deadwood_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/deadwood_carbon/loss_pixels/standard/20191017/{tile_id}_t_deadwood_C_ha_emis_year_2000.tif",
    ...
    "litter_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/litter_carbon/loss_pixels/standard/20191017/{tile_id}_t_litter_C_ha_emis_year_2000.tif",
    ...
    "soil_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/standard/20191017/{tile_id}_t_soil_C_ha_emis_year_2000.tif",
        # "s3_target": "{protocol}/gfw-files/2018_update/soil_carbon_emis_year/standard/{tile_id}.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/soil_carbon_emis_year/maxgain/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "total_carbon_emis_year": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/total_carbon/loss_pixels/standard/20191017/{tile_id}_t_total_C_ha_emis_year.tif",
    ...
    "agc_2000": {
        ...
        "s3_target": "{protocol}/gfw-files/2018_update/agc_2000/maxgain/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "bgc_2000": {
    ...
    "soil_carbon_2000": {
        ...
        "s3_target": "{protocol}/gfw-files/2018_update/soil_carbon_2000/maxgain/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "total_carbon_2000": {
    ...
    "gross_emissions_co2_only_co2e": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/CO2_only/biomass_soil/standard/20191017/{tile_id}_gross_emis_CO2_only_all_drivers_t_CO2e_ha_biomass_soil.tif",
    ...
    "gross_emissions_non_co2_co2e": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/non_CO2/biomass_soil/standard/20191017/{tile_id}_gross_emis_non_CO2_all_drivers_t_CO2e_ha_biomass_soil.tif",
    ...
    "net_flux_co2e": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/net_flux_all_forest_types_all_drivers/biomass_soil/standard/20191017/{tile_id}_net_flux_t_CO2e_ha_2001_15_biomass_soil.tif",
