...
SRC = {
    ...
    "gross_cumul_removals_co2": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/cumulative_gain_AGCO2_BGCO2_all_forest_types/biomass_swap/20191226/{tile_id}_cumul_gain_AGCO2_BGCO2_t_ha_all_forest_types_2001_15_biomass_swap.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/gross_cumul_removals_co2/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/cumulative_gain_AGCO2_BGCO2_all_forest_types/US_removals/20191226/{tile_id}_cumul_gain_AGCO2_BGCO2_t_ha_all_forest_types_2001_15_US_removals.tif",
    ...
    "agc_emis_year": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/biomass_swap/20191226/{tile_id}_t_AGC_ha_emis_year_biomass_swap.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/agc_emis_year/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/US_removals/20191226/{tile_id}_t_AGC_ha_emis_year_US_removals.tif",
    ...
    "soil_carbon_emis_year": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/biomass_swap/20191226/{tile_id}_t_soil_C_ha_emis_year_2000_biomass_swap.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/soil_carbon_emis_year/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/US_removals/20191226/{tile_id}_t_soil_C_ha_emis_year_2000_US_removals.tif",
    ...
    "gross_emissions_co2_only_co2e": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/CO2_only/biomass_soil/biomass_swap/20191227/{tile_id}_gross_emis_CO2_only_all_drivers_t_CO2e_ha_biomass_soil_biomass_swap.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/gross_emissions_co2_only_co2e/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/CO2_only/biomass_soil/US_removals/20191227/{tile_id}_gross_emis_CO2_only_all_drivers_t_CO2e_ha_biomass_soil_US_removals.tif",
    ...
    "gross_emissions_non_co2_co2e": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/non_CO2/biomass_soil/biomass_swap/20191227/{tile_id}_gross_emis_non_CO2_all_drivers_t_CO2e_ha_biomass_soil_biomass_swap.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/gross_emissions_non_co2_co2e/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/non_CO2/biomass_soil/US_removals/20191227/{tile_id}_gross_emis_non_CO2_all_drivers_t_CO2e_ha_biomass_soil_US_removals.tif",
    ...
    "net_flux_co2e": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/net_flux_all_forest_types_all_drivers/biomass_soil/biomass_swap/20191227/{tile_id}_net_flux_t_CO2e_ha_2001_15_biomass_soil_biomass_swap.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/net_flux_co2e/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/net_flux_all_forest_types_all_drivers/biomass_soil/US_removals/20191227/{tile_id}_net_flux_t_CO2e_ha_2001_15_biomass_soil_US_removals.tif",
    ...
    "forest_age_category": {
        ...
        "s3_target": "{protocol}/gfw-files/2018_update/forest_age_category/{tile_id}.tif",
        "data_type": "Byte",
        "nodata": 0
    },
    "ifl_primary": {
