...
SRC = {
    ...
    "gross_cumul_removals_co2": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/cumulative_gain_AGCO2_BGCO2_all_forest_types/legal_Amazon_loss/20200115/{tile_id}_cumul_gain_AGCO2_BGCO2_t_ha_all_forest_types_2001_15_legal_Amazon_loss.tif",
    ...
    "agc_emis_year": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/aboveground_carbon/loss_pixels/legal_Amazon_loss/20200115/{tile_id}_t_AGC_ha_emis_year_legal_Amazon_loss.tif",
    ...
    "soil_carbon_emis_year": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/legal_Amazon_loss/20200115/{tile_id}_t_soil_C_ha_emis_year_2000_legal_Amazon_loss.tif",
    ...
    "gross_emissions_co2_only_co2e": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/CO2_only/biomass_soil/legal_Amazon_loss/20200115/{tile_id}_gross_emis_CO2_only_all_drivers_t_CO2e_ha_biomass_soil_legal_Amazon_loss.tif",
    ...
    "gross_emissions_non_co2_co2e": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/gross_emissions/all_drivers/non_CO2/biomass_soil/legal_Amazon_loss/20200115/{tile_id}_gross_emis_non_CO2_all_drivers_t_CO2e_ha_biomass_soil_legal_Amazon_loss.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/gross_emissions_non_co2_co2e/legal_Amazon_loss/{tile_id}.tif",
        "data_type": "Float32",
        "nodata": 0,
    },
    "net_flux_co2e": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/net_flux_all_forest_types_all_drivers/biomass_soil/legal_Amazon_loss/20200115/{tile_id}_net_flux_t_CO2e_ha_2001_15_biomass_soil_legal_Amazon_loss.tif",
    ...
    "legal_Amazon_2000": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/sensit_analysis_legal_Amazon_loss/forest_extent_2000/processed/tiles/20200114/{tile_id}_legal_Amazon_forest_extent_2000.tif",
        "s3_target": "{protocol}/gfw-files/2018_update/Prodes_legal_Amazon_2000/{tile_id}.tif",
        "data_type": "Byte",
        "nodata": 0
    },
    "legal_Amazon_annual_loss": {
        "type": "raster",
        "src": "{protocol}/gfw2-data/climate/carbon_model/sensit_analysis_legal_Amazon_loss/annual_loss/processed/tiles/20200114/{tile_id}_legal_Amazon_annual_loss_2001_2015.tif",
