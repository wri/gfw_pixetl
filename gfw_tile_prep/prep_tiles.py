...
SRC = {
    ...
    "SoilCarbonEmisYear": {
        ...
        "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/maxgain/20200915/{tile_id}_Mg_AGC_ha_emis_year_maxgain.tif",
        "s3_target": "{protocol}/gfw-files/flux_2_1_0/soil_emis_year/maxgain/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/biomass_swap/20200919/{tile_id}_Mg_AGC_ha_emis_year_biomass_swap.tif",
        # "s3_target": "{protocol}/gfw-files/flux_2_1_0/soil_emis_year/biomass_swap/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/US_removals/20200919/{tile_id}_Mg_AGC_ha_emis_year_US_removals.tif",
        # "s3_target": "{protocol}/gfw-files/flux_2_1_0/soil_emis_year/US_removals/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/no_primary_gain/20200918/{tile_id}_Mg_AGC_ha_emis_year_no_primary_gain.tif",
        # "s3_target": "{protocol}/gfw-files/flux_2_1_0/soil_emis_year/no_primary_gain/{tile_id}.tif",
        # "src": "{protocol}/gfw2-data/climate/carbon_model/carbon_pools/soil_carbon/loss_pixels/legal_Amazon_loss/20200920/{tile_id}_Mg_AGC_ha_emis_year_legal_Amazon_loss.tif",
